...
const Benefits = ({ setSelectedPage }: Props) => {
  return (
    <section
        id="benefits"
        className="mx-auto min-h-full w-5/6 py-20 pt-40"
    >
        <motion.div
        ...
        >
            ...
            <div className="mt-16 items-center justofy-between gap-20 md:mt-28 md:flex">
                {/* GRAPHIC */}
                <img className="mx-auto" alt='beenfits-graphic' src={BenefitsPageGraphic}/>
